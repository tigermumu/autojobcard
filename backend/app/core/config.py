...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "Aircraft Workcard Processing System"
    
    # Database configuration
    # DATABASE_URL: str = os.getenv("DATABASE_URL", "postgresql://postgres:password@localhost:5432/aircraft_workcard")
    DATABASE_URL: str = os.getenv("DATABASE_URL", "sqlite:///./aircraft_workcard.db")
    # Redis configuration
    ...
    ALGORITHM_WEIGHTS: dict = {
        "main_area": 0.05,
        "main_component": 0.20,
        "first_level_subcomponent": 0.35,  # First level subcomponent has highest weight
